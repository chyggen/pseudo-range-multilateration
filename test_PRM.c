...
// test dataset generated by test_generator.py:
        ...
        setCoord(&sat_coords[0], 1717644812, -1199171243, -443195291);
        setCoord(&sat_coords[1], 492244078, -489769458, -2025477495);
        setCoord(&sat_coords[2], 1293081545, -1066738038, -1332196499);
        setCoord(&sat_coords[3], 1597142122, -618191027, -1285190388);
        setCoord(&emitter_true_coords, 255402766, -182200528, -598028093);

        getGPSData(&sats[0], sat_coords[0], 36845);
        getGPSData(&sats[1], sat_coords[1], 30486);
        getGPSData(&sats[2], sat_coords[2], 31914);
        getGPSData(&sats[3], sat_coords[3], 32340);
